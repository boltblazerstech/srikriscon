...
INSERT INTO users (email, password, first_name, last_name, phone, role, is_active, email_verified) VALUES
  ('rahul.sharma@gmail.com',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Rahul',  'Sharma', '9876543210', 'CUSTOMER', TRUE, TRUE),
  ('priya.patel@gmail.com',   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Priya',  'Patel',  '9123456789', 'CUSTOMER', TRUE, TRUE),
  ('amit.kumar@outlook.com',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Amit',   'Kumar',  '8765432109', 'CUSTOMER', TRUE, TRUE),
  ('sneha.singh@yahoo.com',   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Sneha',  'Singh',  '7654321098', 'CUSTOMER', TRUE, TRUE),
  ('vikram.nair@gmail.com',   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Vikram', 'Nair',   '9988776655', 'CUSTOMER', TRUE, TRUE);

-- ─── Extra Admin Users ────────────────────────────────────────────────────────
INSERT INTO admin_users (email, password, first_name, last_name, role, is_active) VALUES
  ('manager@example.com',   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Ananya', 'Verma', 'ADMIN', TRUE),
  ('inventory@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Rohit',  'Mehta', 'ADMIN', TRUE);
...
INSERT INTO categories (name, slug, description, sort_order, is_active) VALUES
  ('Sports & Fitness', 'sports-fitness', 'Sports equipment and fitness accessories', 5, TRUE),
  ('Beauty & Personal Care', 'beauty-personal-care', 'Skincare, haircare and personal hygiene', 6, TRUE);
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Bluetooth Portable Speaker', 'bluetooth-portable-speaker',
    ...
    'IPX7 waterproof, 360° sound, 12h battery.', 1499.00, 1999.00, 'AUDIO-002', 80, id, TRUE, TRUE, 2, 1
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'True Wireless Earbuds Pro', 'true-wireless-earbuds-pro',
    ...
    2299.00, 2999.00, 'AUDIO-003', 60, id, TRUE, TRUE, 3, 1
  FROM categories WHERE slug = 'audio';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Ergonomic Wireless Mouse', 'ergonomic-wireless-mouse',
    ...
    899.00, 1299.00, 'COMP-002', 45, id, TRUE, FALSE, 3, 1
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT '7-in-1 USB-C Hub', 'usbc-hub-7in1',
    ...
    1299.00, 1799.00, 'COMP-003', 35, id, TRUE, TRUE, 4, 1
  FROM categories WHERE slug = 'computers';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT '27-inch 4K IPS Monitor', '27inch-4k-monitor',
    ...
    21999.00, 27999.00, 'COMP-004', 15, id, TRUE, TRUE, 5, 1
  FROM categories WHERE slug = 'computers';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT '65W GaN Fast Charger', '65w-gan-fast-charger',
    ...
    1899.00, 2499.00, 'MOBILE-001', 100, id, TRUE, TRUE, 1, 1
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Premium Tempered Glass Screen Protector', 'premium-screen-protector',
    ...
    299.00, 499.00, 'MOBILE-002', 200, id, TRUE, FALSE, 2, 1
  FROM categories WHERE slug = 'mobile-phones';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Slim Fit Stretch Jeans', 'slim-fit-stretch-jeans',
    ...
    1499.00, 1999.00, 'CLO-002', 120, id, TRUE, TRUE, 2, 1
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Premium Hooded Sweatshirt', 'premium-hooded-sweatshirt',
    ...
    1799.00, 2299.00, 'CLO-003', 85, id, TRUE, TRUE, 3, 1
  FROM categories WHERE slug = 'clothing';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Classic Pique Polo Shirt', 'classic-polo-shirt',
    ...
    799.00, 999.00, 'CLO-004', 150, id, TRUE, FALSE, 4, 1
  FROM categories WHERE slug = 'clothing';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Clean Code', 'clean-code',
    ...
    649.00, 799.00, 'BOOK-002', 40, id, TRUE, TRUE, 2, 1
  FROM categories WHERE slug = 'books';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Atomic Habits', 'atomic-habits',
    ...
    449.00, 599.00, 'BOOK-003', 90, id, TRUE, TRUE, 1, 1
  FROM categories WHERE slug = 'books';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Deep Work', 'deep-work',
    ...
    399.00, 499.00, 'BOOK-004', 55, id, TRUE, FALSE, 2, 1
  FROM categories WHERE slug = 'books';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT '1L Insulated Stainless Steel Bottle', 'insulated-water-bottle-1l',
    ...
    799.00, 1099.00, 'HOME-001', 130, id, TRUE, TRUE, 1, 1
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Ceramic Coffee Mug Set (4 Pcs)', 'ceramic-mug-set-4',
    ...
    899.00, 1199.00, 'HOME-002', 70, id, TRUE, FALSE, 2, 1
  FROM categories WHERE slug = 'kitchen-dining';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'LED Architect Desk Lamp', 'led-desk-lamp',
    ...
    1599.00, 1999.00, 'HOME-003', 45, id, TRUE, TRUE, 1, 1
  FROM categories WHERE slug = 'home-garden';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Professional Yoga Mat 6mm', 'yoga-mat-6mm',
    ...
    1199.00, 1599.00, 'SPORT-001', 90, id, TRUE, TRUE, 1, 1
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Resistance Bands Set (5 Levels)', 'resistance-bands-set',
    ...
    799.00, 1099.00, 'SPORT-002', 110, id, TRUE, TRUE, 2, 1
  FROM categories WHERE slug = 'sports-fitness';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Adjustable Dumbbell Set 2.5–10kg', 'adjustable-dumbbell-set',
    ...
    3499.00, 4499.00, 'SPORT-003', 25, id, TRUE, FALSE, 3, 1
  FROM categories WHERE slug = 'sports-fitness';
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Vitamin C Face Serum 30ml', 'vitamin-c-face-serum',
    ...
    899.00, 1299.00, 'BEAUTY-001', 80, id, TRUE, TRUE, 1, 1
...
INSERT INTO products (name, slug, description, short_description, price, compare_price, sku, stock_quantity, category_id, is_active, is_featured, sort_order, min_order_qty)
  SELECT 'Daily Moisturizer SPF 30 (50ml)', 'daily-moisturizer-spf30',
    ...
    699.00, 999.00, 'BEAUTY-002', 95, id, TRUE, FALSE, 2, 1
  FROM categories WHERE slug = 'beauty-personal-care';

-- ─── Product Images ───────────────────────────────────────────────────────────
-- Existing products
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/headphones1/600/600', 'Wireless Headphones front', 0, TRUE FROM products WHERE slug = 'wireless-headphones';
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/headphones2/600/600', 'Wireless Headphones side', 1, FALSE FROM products WHERE slug = 'wireless-headphones';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/keyboard1/600/600', 'Mechanical Keyboard top', 0, TRUE FROM products WHERE slug = 'mechanical-keyboard';
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/keyboard2/600/600', 'Mechanical Keyboard angle', 1, FALSE FROM products WHERE slug = 'mechanical-keyboard';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/tshirt1/600/600', 'Classic White T-Shirt front', 0, TRUE FROM products WHERE slug = 'classic-white-t-shirt';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/springbook1/600/600', 'Spring Boot in Action cover', 0, TRUE FROM products WHERE slug = 'spring-boot-in-action';

-- New products
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/btspeaker1/600/600', 'Bluetooth Speaker front', 0, TRUE FROM products WHERE slug = 'bluetooth-portable-speaker';
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/btspeaker2/600/600', 'Bluetooth Speaker top', 1, FALSE FROM products WHERE slug = 'bluetooth-portable-speaker';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/earbuds1/600/600', 'Earbuds Pro in case', 0, TRUE FROM products WHERE slug = 'true-wireless-earbuds-pro';
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/earbuds2/600/600', 'Earbuds Pro worn', 1, FALSE FROM products WHERE slug = 'true-wireless-earbuds-pro';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/mouse1/600/600', 'Ergonomic Mouse side', 0, TRUE FROM products WHERE slug = 'ergonomic-wireless-mouse';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/usbchub1/600/600', 'USB-C Hub ports', 0, TRUE FROM products WHERE slug = 'usbc-hub-7in1';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/monitor4k1/600/600', '4K Monitor front', 0, TRUE FROM products WHERE slug = '27inch-4k-monitor';
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/monitor4k2/600/600', '4K Monitor angle', 1, FALSE FROM products WHERE slug = '27inch-4k-monitor';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/gancharger1/600/600', 'GaN Charger', 0, TRUE FROM products WHERE slug = '65w-gan-fast-charger';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/screenprotect1/600/600', 'Screen Protector', 0, TRUE FROM products WHERE slug = 'premium-screen-protector';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/jeans1/600/600', 'Slim Fit Jeans front', 0, TRUE FROM products WHERE slug = 'slim-fit-stretch-jeans';
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/jeans2/600/600', 'Slim Fit Jeans detail', 1, FALSE FROM products WHERE slug = 'slim-fit-stretch-jeans';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/hoodie1/600/600', 'Hooded Sweatshirt front', 0, TRUE FROM products WHERE slug = 'premium-hooded-sweatshirt';
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/hoodie2/600/600', 'Hooded Sweatshirt back', 1, FALSE FROM products WHERE slug = 'premium-hooded-sweatshirt';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/polo1/600/600', 'Polo Shirt front', 0, TRUE FROM products WHERE slug = 'classic-polo-shirt';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/cleancode1/600/600', 'Clean Code book cover', 0, TRUE FROM products WHERE slug = 'clean-code';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/atomichabits1/600/600', 'Atomic Habits book cover', 0, TRUE FROM products WHERE slug = 'atomic-habits';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/deepwork1/600/600', 'Deep Work book cover', 0, TRUE FROM products WHERE slug = 'deep-work';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/bottle1/600/600', 'Insulated Bottle', 0, TRUE FROM products WHERE slug = 'insulated-water-bottle-1l';
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/bottle2/600/600', 'Insulated Bottle open lid', 1, FALSE FROM products WHERE slug = 'insulated-water-bottle-1l';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/mugs1/600/600', 'Ceramic Mug Set', 0, TRUE FROM products WHERE slug = 'ceramic-mug-set-4';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/desklamp1/600/600', 'LED Desk Lamp', 0, TRUE FROM products WHERE slug = 'led-desk-lamp';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/yogamat1/600/600', 'Yoga Mat rolled', 0, TRUE FROM products WHERE slug = 'yoga-mat-6mm';
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/yogamat2/600/600', 'Yoga Mat flat', 1, FALSE FROM products WHERE slug = 'yoga-mat-6mm';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/resistbands1/600/600', 'Resistance Bands set', 0, TRUE FROM products WHERE slug = 'resistance-bands-set';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/dumbbells1/600/600', 'Adjustable Dumbbells', 0, TRUE FROM products WHERE slug = 'adjustable-dumbbell-set';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/vitcserum1/600/600', 'Vitamin C Serum bottle', 0, TRUE FROM products WHERE slug = 'vitamin-c-face-serum';

INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary)
  SELECT id, 'https://picsum.photos/seed/moisturizer1/600/600', 'Daily Moisturizer jar', 0, TRUE FROM products WHERE slug = 'daily-moisturizer-spf30';

-- ─── Product Variants ─────────────────────────────────────────────────────────
-- Classic White T-Shirt — SIZE
INSERT INTO product_variants (product_id, type, value, price, stock_quantity, is_active, sort_order)
  SELECT id, 'SIZE', 'XS', 799.00, 20, TRUE, 1 FROM products WHERE slug = 'classic-white-t-shirt'
  UNION ALL SELECT id, 'SIZE', 'S',  799.00, 40, TRUE, 2 FROM products WHERE slug = 'classic-white-t-shirt'
  UNION ALL SELECT id, 'SIZE', 'M',  799.00, 50, TRUE, 3 FROM products WHERE slug = 'classic-white-t-shirt'
  UNION ALL SELECT id, 'SIZE', 'L',  799.00, 45, TRUE, 4 FROM products WHERE slug = 'classic-white-t-shirt'
  UNION ALL SELECT id, 'SIZE', 'XL', 799.00, 30, TRUE, 5 FROM products WHERE slug = 'classic-white-t-shirt'
  UNION ALL SELECT id, 'SIZE', 'XXL',849.00, 15, TRUE, 6 FROM products WHERE slug = 'classic-white-t-shirt';

-- Slim Fit Jeans — SIZE
INSERT INTO product_variants (product_id, type, value, price, stock_quantity, is_active, sort_order)
  SELECT id, 'SIZE', '28', 1499.00, 20, TRUE, 1 FROM products WHERE slug = 'slim-fit-stretch-jeans'
  UNION ALL SELECT id, 'SIZE', '30', 1499.00, 30, TRUE, 2 FROM products WHERE slug = 'slim-fit-stretch-jeans'
  UNION ALL SELECT id, 'SIZE', '32', 1499.00, 35, TRUE, 3 FROM products WHERE slug = 'slim-fit-stretch-jeans'
  UNION ALL SELECT id, 'SIZE', '34', 1499.00, 25, TRUE, 4 FROM products WHERE slug = 'slim-fit-stretch-jeans'
  UNION ALL SELECT id, 'SIZE', '36', 1549.00, 10, TRUE, 5 FROM products WHERE slug = 'slim-fit-stretch-jeans';

-- Hooded Sweatshirt — SIZE
INSERT INTO product_variants (product_id, type, value, price, stock_quantity, is_active, sort_order)
  SELECT id, 'SIZE', 'S',   1799.00, 15, TRUE, 1 FROM products WHERE slug = 'premium-hooded-sweatshirt'
  UNION ALL SELECT id, 'SIZE', 'M',   1799.00, 25, TRUE, 2 FROM products WHERE slug = 'premium-hooded-sweatshirt'
  UNION ALL SELECT id, 'SIZE', 'L',   1799.00, 25, TRUE, 3 FROM products WHERE slug = 'premium-hooded-sweatshirt'
  UNION ALL SELECT id, 'SIZE', 'XL',  1799.00, 15, TRUE, 4 FROM products WHERE slug = 'premium-hooded-sweatshirt'
  UNION ALL SELECT id, 'SIZE', 'XXL', 1899.00, 5,  1, 5 FROM products WHERE slug = 'premium-hooded-sweatshirt';

-- Polo Shirt — SIZE
INSERT INTO product_variants (product_id, type, value, price, stock_quantity, is_active, sort_order)
  SELECT id, 'SIZE', 'S',   799.00, 25, TRUE, 1 FROM products WHERE slug = 'classic-polo-shirt'
  UNION ALL SELECT id, 'SIZE', 'M',   799.00, 40, TRUE, 2 FROM products WHERE slug = 'classic-polo-shirt'
  UNION ALL SELECT id, 'SIZE', 'L',   799.00, 45, TRUE, 3 FROM products WHERE slug = 'classic-polo-shirt'
  UNION ALL SELECT id, 'SIZE', 'XL',  799.00, 30, TRUE, 4 FROM products WHERE slug = 'classic-polo-shirt'
  UNION ALL SELECT id, 'SIZE', 'XXL', 849.00, 10, TRUE, 5 FROM products WHERE slug = 'classic-polo-shirt';

-- Yoga Mat — DESIGN (colour)
INSERT INTO product_variants (product_id, type, value, price, stock_quantity, is_active, sort_order)
  SELECT id, 'DESIGN', 'Midnight Black', 1199.00, 20, TRUE, 1 FROM products WHERE slug = 'yoga-mat-6mm'
  UNION ALL SELECT id, 'DESIGN', 'Ocean Blue',    1199.00, 20, TRUE, 2 FROM products WHERE slug = 'yoga-mat-6mm'
  UNION ALL SELECT id, 'DESIGN', 'Coral Pink',    1199.00, 20, TRUE, 3 FROM products WHERE slug = 'yoga-mat-6mm'
  UNION ALL SELECT id, 'DESIGN', 'Forest Green',  1199.00, 15, TRUE, 4 FROM products WHERE slug = 'yoga-mat-6mm'
  UNION ALL SELECT id, 'DESIGN', 'Lavender',      1199.00, 15, TRUE, 5 FROM products WHERE slug = 'yoga-mat-6mm';

-- Insulated Bottle — DESIGN (colour)
INSERT INTO product_variants (product_id, type, value, price, stock_quantity, is_active, sort_order)
  SELECT id, 'DESIGN', 'Matte Black',   799.00, 30, TRUE, 1 FROM products WHERE slug = 'insulated-water-bottle-1l'
  UNION ALL SELECT id, 'DESIGN', 'Arctic White',  799.00, 30, TRUE, 2 FROM products WHERE slug = 'insulated-water-bottle-1l'
  UNION ALL SELECT id, 'DESIGN', 'Navy Blue',     799.00, 35, TRUE, 3 FROM products WHERE slug = 'insulated-water-bottle-1l'
  UNION ALL SELECT id, 'DESIGN', 'Forest Green',  799.00, 35, TRUE, 4 FROM products WHERE slug = 'insulated-water-bottle-1l';
...
INSERT INTO testimonials (name, designation, company, content, rating, sort_order, is_active) VALUES
  ('Rahul Sharma',  'Software Engineer',     'Infosys',        'The wireless headphones are amazing! Crystal clear sound and the noise-cancellation is top-notch. Delivered in just 3 days. Highly recommend this store!', 5, 1, TRUE),
  ('Priya Patel',   'Graphic Designer',      'Freelancer',     'Ordered the Bluetooth speaker and the Vitamin C serum. Both arrived well-packaged and exactly as described. The speaker quality blew me away for the price!', 5, 2, TRUE),
  ('Amit Kumar',    'Product Manager',       'Flipkart',       'Bought the 4K monitor — setup was seamless, colors are gorgeous. Genuine product, great price. Customer support was super helpful when I had a query.',        5, 3, TRUE),
  ('Sneha Singh',   'Teacher',               'Self-employed',  'Love the ceramic mug set — the packaging was so premium it felt like a luxury gift. Already ordered two more sets for friends. Fast shipping to Chennai!',      5, 4, TRUE),
  ('Vikram Nair',   'Fitness Trainer',       'Gold''s Gym',    'Yoga mat is solid — great grip and the alignment lines are genuinely useful. The resistance bands are tough and stretchy. My whole studio uses these now.',       5, 5, TRUE),
  ('Divya Menon',   'Content Creator',       'YouTube',        'The GaN charger is a game-changer — charges my MacBook, phone, and iPad simultaneously. Compact enough to fit in my camera bag. 10/10 purchase.',              5, 6, TRUE),
  ('Karan Mehta',   'Data Analyst',          'Deloitte',       'Clean Code book changed how I write code professionally. Delivery was fast and the book condition was perfect. Will definitely order more technical books here.', 4, 7, TRUE),
  ('Anjali Reddy',  'Skincare Enthusiast',   'Nykaa',          'The Vitamin C serum actually works! Noticed a visible difference in 3 weeks. The moisturizer with SPF is perfect for daily use. Genuine products, great prices.', 5, 8, TRUE);
