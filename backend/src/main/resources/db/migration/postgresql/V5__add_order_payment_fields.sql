...
ALTER TABLE orders ADD COLUMN awb_code VARCHAR(100);
...
ALTER TABLE order_items ADD COLUMN variant_type VARCHAR(20);
ALTER TABLE order_items ADD COLUMN variant_value VARCHAR(100);
